...
public class LoginAndOverview {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void loginAndOverview() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.username),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("rain"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.username_text),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                1)));
        appCompatEditText5.perform(scrollTo(), replaceText("rain"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.subscription_name),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("Netflix"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.subscription_cost),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("10.00"), closeSoftKeyboard());
        ...
        ViewInteraction materialAutoCompleteTextView3 = onView(
                allOf(withId(R.id.every), withText("year"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        materialAutoCompleteTextView3.perform(replaceText("month"));

        ViewInteraction materialAutoCompleteTextView4 = onView(
                allOf(withId(R.id.every), withText("month"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.text_input_layout4),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.home_budget), withText("Current Budget $50.00"),
                        withParent(allOf(withId(R.id.home_budgetId),
                                withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class)))),
                        isDisplayed()));
        textView.check(matches(withText("Current Budget $50.00")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.home_spend), withText("Total Spend $10.00"),
                        withParent(allOf(withId(R.id.home_spendId),
                                withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class)))),
                        isDisplayed()));
        textView2.check(matches(withText("Total Spend $10.00")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.home_total_app), withText("Total number of Subscriptions #1"),
                        withParent(allOf(withId(R.id.home_total_appId),
                                withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class)))),
                        isDisplayed()));
        textView3.check(matches(withText("Total number of Subscriptions #1")));

        ViewInteraction textView4 = onView(
                allOf(withId(R.id.home_rem_budget), withText("Remaining Budget $40.00"),
                        withParent(allOf(withId(R.id.home_rem_budgetId),
                                withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class)))),
                        isDisplayed()));
        textView4.check(matches(withText("Remaining Budget $40.00")));
    }
